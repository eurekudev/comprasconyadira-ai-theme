...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ in_array(app()->getLocale(), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) ? 'rtl' : 'ltr' }}">
	<head>
		...
		@if( in_array(app()->getLocale(), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) )
			<link type="text/css" rel="stylesheet" href="{{ asset('vendor/shop/themes/comprasconyadira-ai-theme/app.rtl.css?v=' . config( 'shop.version', 1 ) ) }}">
		@else
		...
		<link rel="icon" href="{{ asset( 'aimeos/' . ( app( 'aimeos.context' )->get()->locale()->getSiteItem()->getIcon() ?: '../vendor/shop/themes/comprasconyadira-ai-theme/assets/icon.png' ) ) }}"/>

		<link rel="preload" href="/vendor/shop/themes/comprasconyadira-ai-theme/assets/roboto-condensed-v19-latin-regular.woff2" as="font" type="font/woff2" crossorigin>
		<link rel="preload" href="/vendor/shop/themes/comprasconyadira-ai-theme/assets/roboto-condensed-v19-latin-700.woff2" as="font" type="font/woff2" crossorigin>
		<link rel="preload" href="/vendor/shop/themes/comprasconyadira-ai-theme/assets/bootstrap-icons.woff2" as="font" type="font/woff2" crossorigin>
	</head>
	<body class="{{ $page ?? '' }}">
		...
		<!-- Scripts -->
		<script src="{{ asset('vendor/shop/themes/comprasconyadira-ai-theme/app.js?v=' . config( 'shop.version', 1 ) ) }}"></script>
		<script src="{{ asset('vendor/shop/themes/comprasconyadira-ai-theme/aimeos.js?v=' . config( 'shop.version', 1 ) ) }}"></script>
